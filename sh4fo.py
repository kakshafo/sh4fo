...
if os.name=='nt':os.system("start https://instagram.com/sh4f0r1i?utm_medium=copy_link")
else:os.system("xdg-open https://instagram.com/sh4f0r1i?utm_medium=copy_link")
os.system(oss)
os.system(oss)
...
╰━━━┻╯╱╰╯╱╱╰┻╯╱╱╰━━━╯
 ...
 -------------------------------------------
   Author   : SHAFO Coder
    facebook   :sh4fo✓ 
    BY       : sh4fo cracker
    telegram : https://t.me/Husash4lati
 -------------------------------------------'''
logo2='''
